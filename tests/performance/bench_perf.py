...
Run with:
    pytest tests/performance/bench_perf.py --suite performance -v --benchmark-sort=mean
    pytest tests/performance/bench_perf.py --suite performance -v --benchmark-columns=mean,stddev,rounds,iterations

Disable benchmarking (just run as tests):
    pytest tests/performance/bench_perf.py --suite performance --benchmark-disable

Run only game-cache benchmarks (requires GTA V install):
    pytest tests/performance/bench_perf.py --suite performance --suite integration -v -k "GameCache"
"""
