...
def test_all_frame_channel_types_roundtrip():
    data, length = native.ycd_encode_frame_channels(2, [(3, 32, [1.25, -2.5]), (4, 8, [3, 7]), (5, 4, [2, 9])])
    assert native.ycd_decode_frame_channels(data, 2, 0, length, [(3, 0, 32, 0.0, 0.0), (4, 32, 8, 0.5, -1.0), (5, 40, 4, 0.0, 0.0)]) == [[1.25, -2.5], [0.5, 2.5], [2, 9]]
