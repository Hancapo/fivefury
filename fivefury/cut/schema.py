...
_BUILTIN_STRUCT_ITEMS = [
    ...
    _struct(
        ...
        _entry("fadeInColor", PsoDataTypeUInt, 1, 704),
        ...
        _entry("fadeOutColor", PsoDataTypeUInt, 1, 724),
        ...
        _entry("concatDataList", PsoDataTypeArray, 1, 768, 0x00280022),
    ...
    _struct(
        ...
        _entry("cHandle", PsoDataTypeString, 7, 84),
        _entry("typeFile", PsoDataTypeString, 7, 88),
        _entry("GenericWeaponType", PsoDataTypeUInt, 0, 96),
    ),
    _struct(
    ...
    _struct(
        ...
        _entry("StreamingName", PsoDataTypeString, 7, 48),
        _entry("AnimStreamingBase", PsoDataTypeUInt, 0, 56),
        _entry("athFxListHash", PsoDataTypeString, 7, 64),
    ),
    _struct(
    ...
    _struct(
        ...
        _entry("cName", PsoDataTypeString, 7, 40),
        _entry("StreamingName", PsoDataTypeString, 7, 48),
        _entry("vStartPosition", PsoDataTypeFloat3, 0, 64),
    ),
    _struct(
        "rage__cutfBlockingBoundsObject",
        128,
        _entry("iObjectId", PsoDataTypeSInt, 0, 8),
        _entry("attributeList", PsoDataTypeStructure, 0, 20, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 32),
        _entry("cName", PsoDataTypeString, 7, 40),
        _entry("ARRAYINFO", PsoDataTypeFloat3, 0, 0),
        _entry("vCorners", PsoDataTypeArray, 4, 48, 0x00040004),
        _entry("fHeight", PsoDataTypeFloat, 0, 112),
    ),
    _struct(
        "rage__cutfRemovalBoundsObject",
        128,
        _entry("iObjectId", PsoDataTypeSInt, 0, 8),
        _entry("attributeList", PsoDataTypeStructure, 0, 20, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 32),
    ...
    _struct(
        ...
        _entry("uHourFlags", PsoDataTypeUInt, 0, 180),
        _entry("bStatic", PsoDataTypeBool, 0, 186),
        _entry("AnimStreamingBase", PsoDataTypeUInt, 0, 192),
    ),
    _struct(
    ...
    _struct(
        "rage__cutfEventArgsList",
        48,
        _entry("attributeList", PsoDataTypeStructure, 0, 12, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 24),
        _entry("ARRAYINFO", PsoDataTypeSInt, 0, 0),
        _entry("iEventArgsIndexList", PsoDataTypeArray, 0, 32, 2),
    ),
    _struct(
    ...
    _struct(
        "rage__cutfObjectIdPartialHashEventArgs",
        48,
        _entry("attributeList", PsoDataTypeStructure, 0, 12, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 24),
        _entry("iObjectId", PsoDataTypeSInt, 0, 32),
        _entry("PartialHash", PsoDataTypeUInt, 0, 40),
    ),
    _struct(
    ...
    _struct(
        "rage__cutfFloatBoolValueEventArgs",
        40,
        _entry("attributeList", PsoDataTypeStructure, 0, 12, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 24),
        _entry("bValue", PsoDataTypeBool, 0, 32),
        _entry("fValue", PsoDataTypeFloat, 0, 36),
    ),
    _struct(
    ...
    _struct(
        "rage__cutfVehicleVariationEventArgs",
        72,
        _entry("attributeList", PsoDataTypeStructure, 0, 12, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 24),
        _entry("iObjectId", PsoDataTypeSInt, 0, 32),
        _entry("iMainBodyColour", PsoDataTypeSInt, 0, 40),
        _entry("iSecondBodyColour", PsoDataTypeSInt, 0, 44),
        _entry("iSpecularColour", PsoDataTypeSInt, 0, 48),
        _entry("iWheelTrimColour", PsoDataTypeSInt, 0, 52),
        _entry("iBodyColour5", PsoDataTypeSInt, 0, 56),
        _entry("iLivery", PsoDataTypeSInt, 0, 60),
        _entry("iLivery2", PsoDataTypeSInt, 0, 64),
        _entry("fDirtLevel", PsoDataTypeFloat, 0, 68),
    ),
    _struct(
        "rage__cutfVehicleExtraEventArgs",
        56,
        _entry("attributeList", PsoDataTypeStructure, 0, 12, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 24),
        _entry("iObjectId", PsoDataTypeSInt, 0, 32),
        _entry("ARRAYINFO", PsoDataTypeSInt, 0, 0),
        _entry("pExtraBoneIds", PsoDataTypeArray, 0, 40, 3),
    ),
    _struct(
    ...
    _struct(
        ...
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 24),
        _entry("fValue", PsoDataTypeFloat, 0, 32),
        _entry("color", PsoDataTypeUInt, 1, 40),
    ),
    _struct(
        ...
        _entry("Colour", PsoDataTypeUInt, 1, 72),
    ...
    _struct(
        ...
        _entry("attributeList", PsoDataTypeStructure, 0, 12, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 24),
        _entry("vInitialBoneRotation", PsoDataTypeFloat4, 0, 32),
        _entry("vInitialBoneOffset", PsoDataTypeFloat3, 0, 48),
        _entry("iAttachParentId", PsoDataTypeSInt, 0, 64),
        _entry("iAttachBoneHash", PsoDataTypeUShort, 0, 68),
    ),
    _struct(
    ...
    _struct(
        ...
        _entry("attributeList", PsoDataTypeStructure, 0, 12, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 24),
        _entry("cameraCutHashName", PsoDataTypeString, 7, 32),
        _entry("position", PsoDataTypeFloat3, 0, 48),
        _entry("radius", PsoDataTypeFloat, 0, 64),
        _entry("interpTime", PsoDataTypeFloat, 0, 68),
        _entry("cascadeIndex", PsoDataTypeSInt, 0, 72),
        _entry("enabled", PsoDataTypeBool, 0, 76),
        _entry("interpolateToDisabled", PsoDataTypeBool, 0, 77),
    ),
    _struct(
