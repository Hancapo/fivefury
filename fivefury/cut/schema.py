...
_BUILTIN_STRUCT_ITEMS = [
    ...
    _struct(
        ...
        _entry("cName", PsoDataTypeString, 7, 40),
        _entry("StreamingName", PsoDataTypeString, 7, 48),
        _entry("RenderId", PsoDataTypeUInt, 0, 56),
    ),
    _struct(
    ...
    _struct(
        ...
        _entry("fRadius", PsoDataTypeFloat, 0, 64),
    ),
    _struct(
        "rage__cutfOverlayObject",
        80,
        _entry("iObjectId", PsoDataTypeSInt, 0, 8),
        _entry("attributeList", PsoDataTypeStructure, 0, 20, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 32),
        _entry("cName", PsoDataTypeString, 3, 40),
        _entry("cRenderTargetName", PsoDataTypeString, 3, 56),
        _entry("iOverlayType", PsoDataTypeUInt, 0, 72),
        _entry("modelHashName", PsoDataTypeString, 7, 76),
    ),
    _struct(
        "rage__cutfFixupModelObject",
        80,
        _entry("iObjectId", PsoDataTypeSInt, 0, 8),
        _entry("attributeList", PsoDataTypeStructure, 0, 20, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 32),
    ...
    _struct(
        "rage__cutfDecalEventArgs",
        80,
        _entry("attributeList", PsoDataTypeStructure, 0, 12, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 24),
        _entry("vPosition", PsoDataTypeFloat3, 0, 32),
        _entry("vRotation", PsoDataTypeFloat4, 0, 48),
        _entry("fWidth", PsoDataTypeFloat, 0, 64),
    ...
    _struct(
        ...
        _entry("attributeList", PsoDataTypeStructure, 0, 12, CUT_NAME_VALUES["rage__parAttributeList"]),
        _entry("cutfAttributes", PsoDataTypeStructure, 4, 24),
        _entry("iAttachParentId", PsoDataTypeSInt, 0, 32),
        _entry("iAttachBoneHash", PsoDataTypeUShort, 0, 36),
        _entry("AttachedParentName", PsoDataTypeString, 7, 40),
    ),
    _struct_hash(
        1737539928,
        64,
