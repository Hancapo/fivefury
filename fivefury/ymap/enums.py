...
class YmapEntityFlags(enum.IntFlag):
    """Entity-definition bits, including the IPL light bits consumed at runtime."""
    NONE = 0
    FULLMATRIX = 1 << 0
    ...
    IS_FIXED = 1 << 5
    IS_INTERIOR_LOD = 1 << 6
    IPL_LIGHTS_CAST_STATIC_SHADOWS = 1 << 7
    IPL_LIGHTS_CAST_DYNAMIC_SHADOWS = 1 << 8
    IPL_LIGHTS_IGNORE_DAY_NIGHT_SETTINGS = 1 << 9
    DRAWABLELODUSEALTFADE = 1 << 15
    UNUSED = 1 << 16
    DOESNOTTOUCHWATER = 1 << 17
    DOESNOTSPAWNPEDS = 1 << 18
